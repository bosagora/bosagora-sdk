...
import {
    NoNewBOATokenContractAddress,
    NoOldBOATokenContractAddress,
    NoTokenSwapContractAddress
} from "../../utils/Errors";
...
const oldBOATokenContractAddressMap = new Map<Web3Module, string>();
const newBOATokenContractAddressMap = new Map<Web3Module, string>();
const tokenSwapContractAddressMap = new Map<Web3Module, string>();
...
export class Web3Module implements IClientWeb3Core {
    ...
    constructor(context: Context) {
        ...
        if (context.oldBOATokenContractAddress) {
            oldBOATokenContractAddressMap.set(this, context.oldBOATokenContractAddress);
        }

        if (context.newBOATokenContractAddress) {
            newBOATokenContractAddressMap.set(this, context.newBOATokenContractAddress);
        }

        if (context.tokenSwapContractAddress) {
            tokenSwapContractAddressMap.set(this, context.tokenSwapContractAddress);
        }
    ...
    private get oldBOATokenContractAddress(): string {
        return oldBOATokenContractAddressMap.get(this) || "";
    }

    private get newBOATokenContractAddress(): string {
        return newBOATokenContractAddressMap.get(this) || "";
    }

    private get tokenSwapContractAddress(): string {
        return tokenSwapContractAddressMap.get(this) || "";
    }
    ...
    public getOldBOATokenContractAddress(): string {
        if (!this.oldBOATokenContractAddress) {
            throw new NoOldBOATokenContractAddress();
        }
        return this.oldBOATokenContractAddress;
    }

    public getNewBOATokenContractAddress(): string {
        if (!this.newBOATokenContractAddress) {
            throw new NoNewBOATokenContractAddress();
        }
        return this.newBOATokenContractAddress;
    }

    public getTokenSwapContractAddress(): string {
        if (!this.tokenSwapContractAddress) {
            throw new NoTokenSwapContractAddress();
        }
        return this.tokenSwapContractAddress;
    }
}
